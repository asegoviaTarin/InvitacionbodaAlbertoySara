...
const Invitation = () => {
  ...
  return (
    <div className="min-h-screen bg-wedding-cream text-stone-800 pb-24 font-sans selection:bg-wedding-gold selection:text-white">
        ...
        {/* Details of the Day Section (containing Location) */}
        <section className="py-24 px-6 bg-[#f5f0e6]">
            <div className="max-w-4xl mx-auto space-y-12 text-center">
                <motion.div 
                    ...
                    className="space-y-4"
                >
                    <h2 className="font-serif text-5xl text-[#3a4030] italic">Detalles del día</h2>
                    <p className="text-[#6b705c] uppercase tracking-widest text-sm">Todo lo que necesitas saber</p>
                </motion.div>
                ...
                >
                    <motion.div variants={fadeInUp} className="flex flex-col items-center space-y-6">
                        <div className="w-20 h-20 bg-[#e3e3dc] rounded-full flex items-center justify-center mb-2">
                             <MapPin className="w-10 h-10 text-[#6b705c]" strokeWidth={1.5} />
                        </div>
                        
                        <div className="space-y-4">
                            <h3 className="font-serif text-3xl text-stone-800">Localización</h3>
                            <h4 className="font-serif text-2xl text-stone-600">Finca Loma de Doña Valle</h4>
        ...
        <div className="flex items-center justify-center gap-4 py-4 bg-[#f5f0e6]">
           <div className="h-[1px] w-16 md:w-32 bg-[#6b705c]/40"></div>
        ...
        {/* Decorative Separator */}
        <div className="flex items-center justify-center gap-4 py-4 bg-stone-100/50">
           <div className="h-[1px] w-16 md:w-32 bg-[#6b705c]/40"></div>
           <div className="text-[#6b705c]">
               <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2L14.5 9.5L22 12L14.5 14.5L12 22L9.5 14.5L2 12L9.5 9.5L12 2Z" />
        ...
        {/* RSVP Section */}
        <section id="rsvp" className="pt-10 pb-24 px-6 relative">
